...
templates['table-template'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<table class=\"table table-bordered\">\r\n    <caption >"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"caption") || (depth0 != null ? lookupProperty(depth0,"caption") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"caption","hash":{},"data":data,"loc":{"start":{"line":2,"column":14},"end":{"line":2,"column":25}}}) : helper)))
    + "</caption>\r\n    <thead >\r\n        <tr>\r\n"
